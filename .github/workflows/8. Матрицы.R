...
# Другой способ решения данной проблемы заключается в
# использовании конструкции drop = FALSE, которая
# позволяет предотвратить превращение столбцов и
# строк матрицы в векторы
...
# Другой способ решения проблемы заключается в
# использовании конструкции drop = FALSE, которая
# позволяет предотвратить превращение столбцов и
# строк матрицы в векторы
m_1[1, , drop = FALSE]              # возвращаем матрицу 1xN
